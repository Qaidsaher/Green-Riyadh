<?php
$active = 'admin.users';
$title = 'إضافة مستخدم - لوحة الإدارة';
ob_start();
?>

<div class="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-xl">
  <h2 class="text-3xl font-bold text-green-700 mb-6 text-center">إضافة مستخدم جديد</h2>
  <?php
  ...
  <form action="<?= route('admin.users.store'); ?>" method="POST" class="space-y-6">
    <div>
      ...
      <input type="text" id="fullName" name="fullName" required placeholder="أدخل الاسم الكامل" class="mt-1 w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring focus:border-green-600">
    </div>
    <div>
    ...
    <div>
      ...
      <input type="text" id="phoneNumber" name="phoneNumber" placeholder="أدخل رقم الهاتف" class="mt-1 w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring focus:border-green-600">
    </div>
    <div>
      <label for="points" class="block text-sm font-medium text-gray-700">النقاط</label>
      <input type="number" id="points" name="points" value="0" class="mt-1 w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring focus:border-green-600">
    </div>
    <div>
